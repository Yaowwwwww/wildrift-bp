...
const I18N = {
  en: {
    ...
    title_version: "Patch: 7.1a &nbsp;&middot;&nbsp; Latest Champion: K'Sante &nbsp;&middot;&nbsp; Author: 长风, 梨花",
    lane_all: "All",
    lane_baron: "Baron",
    lane_jungle: "Jungle",
    lane_mid: "Mid",
    ...
    hp_hint_chain: '<ul class="hp-chain-list"><li><span class="hp-kw">Assassin / Control / Burst</span> → <span class="hp-kw">Hypercarry ADC</span></li><li><span class="hp-kw">Hypercarry ADC</span> → <span class="hp-kw">Tank</span></li><li><span class="hp-kw">Tank</span> → <span class="hp-kw">Assassin / Burst</span></li></ul>',
  ...
  cn: {
    ...
    title_version: "游戏版本：7.1a &nbsp;&middot;&nbsp; 最新英雄：奎桑提 &nbsp;&middot;&nbsp; 作者: 长风, 梨花",
    lane_all: "全部",
    lane_baron: "上单",
    lane_jungle: "打野",
    lane_mid: "中单",
