...
const I18N = {
  en: {
    ...
    hp_hint_comp: '1. <span class="hp-kw">Tank</span> (Vision)<br>2. <span class="hp-kw">Early / Tempo</span><br>3. <span class="hp-kw">Late / Hypercarry ADC</span><br>4. <span class="hp-kw">Reaper / Assassin</span><br>5. <span class="hp-kw">Control</span> (more the better)',
    hp_hint_chain_label: "Counter Chain (→ means counters):",
    hp_hint_chain: '<span class="hp-kw">Assassin / Control / Burst</span><br>&nbsp;&nbsp;→ <span class="hp-kw">Hypercarry ADC</span><br><span class="hp-kw">Hypercarry ADC</span><br>&nbsp;&nbsp;→ <span class="hp-kw">Tank</span><br><span class="hp-kw">Tank</span><br>&nbsp;&nbsp;→ <span class="hp-kw">Assassin / Burst</span>',
  ...
  cn: {
    ...
    hp_hint_chain: '<span class="hp-kw">刺客 / 控制 / 爆发</span><br>&nbsp;&nbsp;→ <span class="hp-kw">后期大C射手</span><br><span class="hp-kw">后期大C射手</span><br>&nbsp;&nbsp;→ <span class="hp-kw">肉</span><br><span class="hp-kw">肉</span><br>&nbsp;&nbsp;→ <span class="hp-kw">刺客 / 爆发</span>',
    no_match: "无匹配英雄",
    delete: "删除",
    remove: "移除",
...
function positionHoverPanel(cardEl) {
  ...
  tooltipEl.style.maxHeight = h + 'px';
