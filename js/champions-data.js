...
const DEFAULT_CHAMP_DATA = {
  Aatrox:       { tags: ["打肉","开团","前期"], counters: ["Ornn","DrMundo"] },
  ...
  Fiddlesticks: { tags: ["控制","开团","爆发"], counters: ["Nocturne","Aatrox","Rengar","Khazix"] },
  ...
  Galio:        { tags: ["硬辅","控制","开团"], counters: ["Katarina","Lux","Fizz"], synergies: ["JarvanIV"] },
  Garen:        { tags: ["战士","肉","前期"], counters: ["Vayne","Rumble","Camille","Jax","Riven"] },
  Gnar:         { tags: ["控制","战士","开团"], counters: ["Irelia","Ornn","Singed","Sett"] },
  Gragas:       { tags: ["控制","开团","肉"], counters: ["DrMundo"] },
  Graves:       { tags: ["爆发","刺客","节奏"], counters: ["Rammus","Amumu","Aatrox","Viego"] },
  Gwen:         { tags: ["后期","打肉","节奏"], counters: ["DrMundo"] },
  ...
  JarvanIV:     { tags: ["控制","开团","肉"], counters: ["Shyvana","MasterYi","Evelynn","Olaf","Nocturne"], synergies: ["Galio"] },
  ...
  Jinx:         { tags: ["大后期","大C射手","打肉"], counters: ["Jhin","MissFortune","KogMaw","Kaisa","Nilah"], synergies: ["Lulu"] },
  ...
  Lissandra:    { tags: ["控制","爆发","开团"], counters: ["Morgana","Kassadin","Fizz","Talon"] },
  Lucian:       { tags: ["前期","大C射手","前中期节奏"], counters: ["Caitlyn","KogMaw","Ashe","Jinx","Kaisa"] },
  Lulu:         { tags: ["增益","控制","后期"], counters: ["Blitzcrank","Senna","Bard","Thresh"], synergies: ["Jinx"] },
  ...
  Olaf:         { tags: ["前期","打肉","节奏"], counters: ["Ornn"] },
  ...
  Riven:        { tags: ["前期","节奏","刺客"], counters: ["Garen"] },
  ...
  Shyvana:      { tags: ["后期","打肉","战士"], counters: ["Ornn"] },
  ...
  Tryndamere:   { tags: ["后期","单带","打肉"], counters: ["Yasuo"] },
  ...
  Yone:         { tags: ["后期","收割","展示"], counters: ["Veigar","AurelionSol"] },
