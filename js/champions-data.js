...
const DEFAULT_CHAMP_DATA = {
  Aatrox:      { tags: ["前期","打肉","开团"], counters: ["Sion","Ornn","DrMundo","Nasus"] },
  Ahri:        { tags: ["刺客","控制","前期"], counters: ["Akali","Syndra","Orianna"] },
  Akali:       { tags: ["刺客","爆发","前期"], counters: ["Veigar","Lissandra","TwistedFate"] },
  Akshan:      { tags: ["刺客","爆发","前期"], counters: ["Yasuo","Vex","Irelia"] },
  Alistar:     { tags: ["硬辅","控制","开团"], counters: ["Janna","Zyra","Ashe"] },
  Ambessa:     { tags: ["刺客","爆发","前期"], counters: ["Renekton","Malphite","Irelia"] },
  Amumu:       { tags: ["控制","开团","肉"], counters: ["Lillia","Nocturne","Nidalee"] },
  Annie:       { tags: ["控制","前期","爆发"], counters: ["Syndra","Lissandra","Viktor"] },
  Ashe:        { tags: ["前期","控制","支援"], counters: ["Caitlyn","Draven","Lucian"] },
  AurelionSol: { tags: ["控制","后期","爆发"], counters: ["Yone","Zed","Yasuo"] },
  Aurora:      { tags: ["爆发","控制","前期"], counters: ["Vex","Zed","Irelia"] },
  Bard:        { tags: ["支援","控制","节奏"], counters: ["Nami","Senna","Zilean"] },
  Blitzcrank:  { tags: ["硬辅","控制","开团"], counters: ["Leona","Braum","Morgana"] },
  Brand:       { tags: ["控制","爆发","前期"], counters: ["Syndra","Zed","Lux"] },
  Braum:       { tags: ["硬辅","控制","开团"], counters: ["Senna","Bard","Zilean"] },
  Caitlyn:     { tags: ["前中期节奏","大C射手","风筝"], counters: ["Sivir","Ezreal","MissFortune"] },
  Camille:     { tags: ["刺客","节奏","单带"], counters: ["Malphite","Fiora","Mordekaiser"] },
  Corki:       { tags: ["后期","爆发","破甲"], counters: ["KogMaw","MissFortune","Caitlyn"] },
  Darius:      { tags: ["战士","前期","节奏"], counters: ["Wukong","Malphite","Jayce"] },
  Diana:       { tags: ["后期","控制","开团"], counters: ["MasterYi","Amumu","Tryndamere"] },
  Draven:      { tags: ["前期","大C射手","前中期节奏"], counters: ["Caitlyn","Samira","KogMaw"] },
  DrMundo:     { tags: ["战士","打肉","前期"], counters: ["Riven","Gwen","Fiora"] },
  Ekko:        { tags: ["刺客","爆发","节奏"], counters: ["Vex","Irelia","Lissandra"] },
  Evelynn:     { tags: ["后期","刺客","节奏"], counters: ["Shyvana","MasterYi","Lillia"] },
  Ezreal:      { tags: ["前期","灵活保命","风筝"], counters: ["Draven","MissFortune","Samira"] },
  Fiddlesticks:{ tags: ["控制","开团","爆发"], counters: ["Nocturne","Aatrox","Alistar"] },
  Fiora:       { tags: ["单带","战士","节奏"], counters: ["Rumble","Malphite","Poppy"] },
  Fizz:        { tags: ["刺客","爆发","节奏"], counters: ["Galio","Lissandra","Vex"] },
  Galio:       { tags: ["硬辅","控制","开团"], counters: ["Katarina","Lux","Fizz"] },
  Garen:       { tags: ["战士","肉","前期"], counters: ["Vayne","Rumble","Camille"] },
  Gnar:        { tags: ["控制","战士","开团"], counters: ["Irelia","Malphite","Ornn"] },
  Gragas:      { tags: ["控制","开团","爆发"], counters: ["Nasus","DrMundo"] },
  Graves:      { tags: ["爆发","刺客","节奏"], counters: ["Rammus","Amumu","Aatrox"] },
  Gwen:        { tags: ["后期","打肉","节奏"], counters: ["Nasus","DrMundo"] },
  Hecarim:     { tags: ["前期","开团","节奏"], counters: ["MasterYi","Amumu","Shyvana","Kayn"] },
  Heimerdinger:{ tags: ["控制","爆发","前期"], counters: ["Zed","Yasuo","Irelia"] },
  Irelia:      { tags: ["战士","单带","前期"], counters: ["Malphite","Wukong","Poppy"] },
  Janna:       { tags: ["风筝","控制","后期"], counters: ["Blitzcrank","Senna","Sona"] },
  JarvanIV:    { tags: ["控制","开团","肉"], counters: ["Shyvana","MasterYi"] },
  Jax:         { tags: ["单带","战士","节奏"], counters: ["Poppy","Teemo","Rumble"] },
  Jayce:       { tags: ["爆发","控制","前期"], counters: ["Syndra","Galio","Irelia"] },
  Jhin:        { tags: ["中后期","大C射手","控制"], counters: ["Draven","Ashe","Lucian"] },
  Jinx:        { tags: ["大后期","大C射手","打肉"], counters: ["Jhin","MissFortune","KogMaw"] },
  Kaisa:       { tags: ["大C射手","风筝","大后期"], counters: ["Caitlyn","Draven","KogMaw"] },
  Kalista:     { tags: ["前期","大C射手","风筝"], counters: ["Ashe","KogMaw","Caitlyn"] },
  Karma:       { tags: ["增益","控制","后期"], counters: ["Pyke","Nami","Bard"] },
  Kassadin:    { tags: ["后期","刺客","爆发"], counters: ["Zed","Yasuo","Jayce"] },
  Katarina:    { tags: ["刺客","爆发","前期"], counters: ["Vex","Zed","Lissandra"] },
  Kayle:       { tags: ["后期","打肉","节奏"], counters: ["Malphite","Teemo","Nasus"] },
  Kayn:        { tags: ["后期","刺客","节奏"], counters: ["Amumu","Shyvana","Pantheon"] },
  Kennen:      { tags: ["爆发","控制","开团"], counters: ["Gnar","Nasus","Wukong"] },
  Khazix:      { tags: ["前期","刺客","节奏"], counters: ["Amumu","MasterYi","Shyvana"] },
  Kindred:     { tags: ["后期","节奏","控制"], counters: ["Amumu","MasterYi","Shyvana","Morgana"] },
  KogMaw:      { tags: ["大后期","大C射手","打肉"], counters: ["Ashe","Caitlyn","Vayne"] },
  KSante:      { tags: ["肉","打肉","控制"], counters: ["Poppy","Kayle","Fiora"] },
  LeeSin:      { tags: ["前期","开团","节奏"], counters: ["MasterYi","Rammus","Vi"] },
  Leona:       { tags: ["硬辅","控制","开团"], counters: ["Galio","Morgana","Janna"] },
  Lillia:      { tags: ["后期","控制","节奏"], counters: ["Evelynn","Vi","MasterYi"] },
  Lissandra:   { tags: ["控制","爆发","开团"], counters: ["Morgana","Kassadin","Galio"] },
  Lucian:      { tags: ["前期","大C射手","前中期节奏"], counters: ["Caitlyn","KogMaw","Ashe"] },
  Lulu:        { tags: ["增益","控制","后期"], counters: ["Blitzcrank","Senna","Bard"] },
  Lux:         { tags: ["控制","爆发","前期"], counters: ["Irelia","Kassadin","Yasuo"] },
  Malphite:    { tags: ["肉","控制","打肉"], counters: ["Rumble","Mordekaiser","Gwen"] },
  Maokai:      { tags: ["控制","开团","肉"], counters: ["Kindred","MasterYi","Olaf"] },
  MasterYi:    { tags: ["后期","节奏","刺客"], counters: ["Shyvana","Diana","Wukong","Olaf"] },
  Mel:         { tags: ["风筝","消耗pole","收割"], counters: ["Irelia","Yone","Syndra"] },
  Milio:       { tags: ["战士","控制","肉"], counters: ["Blitzcrank","Sona","Bard"] },
  MissFortune: { tags: ["中后期","技能射手","风筝"], counters: ["Smolder","Jhin","Caitlyn"] },
  Mordekaiser: { tags: ["针对","前期","控制"], counters: ["Fiora","Irelia","Rumble"] },
  Morgana:     { tags: ["控制","开团","poke消耗"], counters: ["Soraka","Karma","Zyra"] },
  Nami:        { tags: ["增益","控制","消耗"], counters: ["Pyke","Blitzcrank","Braum"] },
  Nasus:       { tags: ["后期","单带","打肉","大后期"], counters: ["Tryndamere","Yasuo","Sion"] },
  Nautilus:    { tags: ["硬辅","控制","开团"], counters: ["Yuumi","Sona","Seraphine"] },
  Nidalee:     { tags: ["前期","节奏","刺客"], counters: ["MasterYi","Amumu","Rammus"] },
  Nilah:       { tags: ["大后期","大C射手","收割"], counters: ["Caitlyn","Xayah","Smolder"] },
  Nocturne:    { tags: ["后期","刺客","节奏"], counters: ["MasterYi","Amumu","Tryndamere"] },
  Norra:       { tags: ["控制","爆发","后期"], counters: ["Kassadin","Zed","Yasuo"] },
  Nunu:        { tags: ["肉","控制","开团"], counters: ["Lillia","Evelynn","Morgana"] },
  Olaf:        { tags: ["前期","打肉","节奏"], counters: ["Sion","Nasus","Ornn"] },
  Orianna:     { tags: ["控制","后期","爆发"], counters: ["Irelia","Yasuo","Syndra"] },
  Ornn:        { tags: ["肉","控制","打肉"], counters: ["Fiora","Camille","Shen"] },
  Pantheon:    { tags: ["前期","刺客","节奏"], counters: ["Nasus","Kayle"] },
  Poppy:       { tags: ["控制","肉","开团"], counters: ["Yasuo","Irelia"] },
  Pyke:        { tags: ["开团","控制","灵活保命"], counters: ["Braum","Maokai","Soraka"] },
  Rakan:       { tags: ["硬辅","开团","支援"], counters: ["Galio","Rell","Nautilus"] },
  Rammus:      { tags: ["控制","肉","开团"], counters: ["MasterYi","Tryndamere"] },
  Rell:        { tags: ["硬辅","控制","开团"], counters: ["Janna","Alistar","Braum"] },
  Renekton:    { tags: ["战士","肉","前期"], counters: ["Gnar","Teemo","Mordekaiser"] },
  Rengar:      { tags: ["刺客","前期","节奏"], counters: ["Kindred","Rammus","MasterYi"] },
  Riven:       { tags: ["前期","节奏","刺客"], counters: ["Garen","Nasus"] },
  Rumble:      { tags: ["后期","爆发","打肉"], counters: ["Renekton","Ornn","Ambessa"] },
  Ryze:        { tags: ["全期","控制","节奏"], counters: ["Kassadin","Viktor","Syndra"] },
  Samira:      { tags: ["前期","大C射手","收割"], counters: ["KogMaw","MissFortune","Caitlyn"] },
  Senna:       { tags: ["风筝","前期","增益"], counters: ["Blitzcrank","Pyke","Nautilus"] },
  Seraphine:   { tags: ["控制","爆发","后期"], counters: ["Pyke","Braum","Blitzcrank"] },
  Sett:        { tags: ["战士","控制","前期"], counters: ["Renekton","Mordekaiser","Aatrox"] },
  Shen:        { tags: ["肉","控制","肉"], counters: ["Fiora","Renekton","Gnar"] },
  Shyvana:     { tags: ["后期","打肉","肉"], counters: ["Nasus","Sion","Ornn"] },
  Singed:      { tags: ["单带","肉","节奏"], counters: ["Ambessa","Fiora","Camille"] },
  Sion:        { tags: ["肉","控制","肉"], counters: ["Renekton","Fiora","Gwen"] },
  Sivir:       { tags: ["前期","控制","支援"], counters: ["KogMaw","Smolder","Vayne"] },
  Smolder:     { tags: ["大后期","大C射手","打肉"], counters: ["Draven","Lucian","Caitlyn"] },
  Sona:        { tags: ["战士","控制","肉"], counters: ["Blitzcrank","Pyke","Bard"] },
  Soraka:      { tags: ["战士","控制","肉"], counters: ["Blitzcrank","Nami","Bard"] },
  Swain:       { tags: ["控制","后期","爆发"], counters: ["Brand","Syndra","Orianna"] },
  Syndra:      { tags: ["控制","后期","爆发"], counters: ["Irelia","Yasuo","Kassadin"] },
  Talon:       { tags: ["前期","刺客","节奏"], counters: ["Veigar","Brand","Ziggs"] },
  Teemo:       { tags: ["前期","风筝","灵活保命"], counters: ["Ryze","Rumble","Wukong"] },
  Thresh:      { tags: ["硬辅","控制","开团"], counters: ["Zyra","Nami","Lux"] },
  Tristana:    { tags: ["中后期","大C射手","风筝"], counters: ["KogMaw","Caitlyn","Draven"] },
  Tryndamere:  { tags: ["后期","单带","打肉"], counters: ["Yasuo","Sion","Nasus"] },
  TwistedFate: { tags: ["支援","控制","节奏"], counters: ["Syndra","Morgana","Mel"] },
  Twitch:      { tags: ["大后期","大C射手","打肉"], counters: ["Ashe","Samira","Caitlyn"] },
